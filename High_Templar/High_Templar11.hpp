...
(
	_implementation::Fold_impl< true, true, Flag<FLAGS...> >
	::	calc( std::forward<CON>(con), std::forward<FUNC>(func), std::forward<init_t>(init) )
)
...
(
	_implementation::Fold_impl< true, false, Flag<FLAGS...> >
	::	calc( std::forward<CON>(con), std::forward<FUNC>(func), std::forward<init_t>(init) )
)
