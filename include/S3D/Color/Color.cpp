...
auto s3d::Colorable::_mod(float const x, int const den)-> float
{
...
auto s3d::Colorable::hsv_to_rgb(s3d::Color_hsv const& hsv)-> Color_rgb
{
...
auto s3d::Colorable::rgb_to_hsv(Color_rgb const& rgb)-> Color_hsv
{
